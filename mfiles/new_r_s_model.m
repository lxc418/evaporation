...
psim_m_ay= -[0.001:0.001:1,1:0.1:10,10:1:100,100:10:1000,1000:500:10000000];
...
[saturation_TSL_ay ,saturation_effective_TSL_ay ] = SWCC_Fayer1995WRR(psim_m_ay, -av_Pm, nv, psi_0_m, saturation_residual);
% figure
...
water_content_NSL_ay           = porosity .* saturation_TSL_ay;
% r_m_ay(r_m_ay<free_path_gas_m) = free_path_gas_m; %no big difference on results
r_3_ay                         = r_avg./(relative_wetted_surface_ay.^0.5);
...
thickness_dry_ay               = thickness_NSL_m;                          
...
evapo_rate_relative            = evapo_rate_relative_capillary;

% surface_resistance_ay          = 1./evapo_rate_relative;
surface_resistance_ay          = thickness_roughness_m/diffusivity_m2Ps./evapo_rate_relative;
...
semilogy(saturation_TSL_ay,surface_resistance_ay);
xlim([0 1.01])
hold on
