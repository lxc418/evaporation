...
r_2_ay(r_2_ay>r_3_ay)          = r_3_ay(r_2_ay>r_3_ay);%if r_m>r_2, r_m=r_2
...
evapo_rate_relative_vapor      = (thickness_aero_edl_m+thickness_funnel_ay)*tortuosity_0*porosity*log(-psi_0_m) /...
...
surface_resistance_ay          = thickness_aero_edl_m/diffusivity_m2Ps*(1./evapo_rate_relative - 1);
%%
figure
