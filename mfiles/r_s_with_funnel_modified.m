...
av_Pm = 5.9;
nv    = 1.48;
radius_particle_m   = 0.2e-4;%average particle size

% av_Pm = 1.5;
% nv    =1.28;
% radius_particle_m   = 0.7e-5;%average particle size
...
r_3_ay = r_2_ay./saturation_effective_TSL_ay.^0.5;

% r_3_ay(saturation_effective_TSL_ay>0.99)=r_m_ay(saturation_effective_TSL_ay>0.99);


thickness_funnel_edl_ay=r_2_ay-r_m_ay;
k_vr_c_ay=1./(1+ thickness_funnel_edl_ay./saturation_effective_TSL_ay/thickness_aero_edl_m  + ...
    1/2/thickness_aero_edl_m * (r_3_ay.^2./r_m_ay - r_3_ay));
...
% surface_resistance_ay_sPm(surface_resistance_ay_sPm<0.01)=0;
%%
% figure
