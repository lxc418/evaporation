...
lw=2;tfs=10;fs=12;ms=5;por=0.38;
...
%    aet6c8(sst8(i):set8(i))=interp1(dtsd(ssts(i):sets(i)),aet6c(ssts(i):sets(i)),dt8d(sst8(i):set8(i)));
 % Transient evaporation of 60cm column at dt85g time series
    ...
    rh538(sst8(i):set8(i))=interp1(dt5d(sst5(i):set5(i)),rh53(sst5(i):set5(i)),dt8d(sst8(i):set8(i)));  
    rh548(sst8(i):set8(i))=interp1(dt5d(sst5(i):set5(i)),rh54(sst5(i):set5(i)),dt8d(sst8(i):set8(i)));   
...
%      h=figure;i=2;
%     plot(dtsd(ssts(i):sets(i))-dtsd(ssts(i)),aet6c(ssts(i):sets(i)),'-','LineWidth',4);hold on
...
%  calculating aerodyn% (max)mum et rate 
   ...
   rab(i,k)=(func.svp(t548(sst8(i))+az)*1./(t548(sst8(i))+az)-func.svp(tma(k)+az)*rh(k)/(tma(k)+az))*mw/R/rholw./etsp8(sst8(i));    
   rsb(sst8(i):set8(i),k)=(func.svp(t548(sst8(i):set8(i))+az)*1./(t548(sst8(i):set8(i))+az)-func.svp(tma(k)+az).*rh(k)./(tma(k)+az))*mw/R/rholw./etsp8(sst8(i):set8(i))-rab(i,k);
...
% remember, here the relative humidty on the soil surface is not based on the measurement at the sensor, instead, it is based on the kelvin equation.
   ...
   rab(i,k)=(func.svp(t548(sst8(i))+az)*1./(t548(sst8(i))+az)-func.svp(t538(sst8(i))+az)*rh538(sst8(i))/(t538(sst8(i))+az))*mw/R/rholw./etsp8(sst8(i));    
   
   rsb(sst8(i):set8(i),k)=(func.svp(t548(sst8(i):set8(i))+az)*1./(t548(sst8(i):set8(i))+az)-func.svp(t538(sst8(i):set8(i))+az).*rh538(sst8(i))./(t548(sst8(i):set8(i))+az))*mw/R/rholw./etsp8(sst8(i):set8(i))-rab(i,k);
...
%        *mw/R/rholw./etsp8(zp8at(i):set8(i))-rat54(i);
 ...
 % using DT(8)5G time series (m/s)
  ...
  va(sst8(i):set8(i))=-kg/miua*( func.svp(t548(sst8(i):set8(i))+az).*rh548(sst8(i):set8(i))- func.svp(t538(sst8(i):set8(i))+az).*rh538(sst8(i):set8(i)) )/dz;
 va1(sst8(i):set8(i))=-kg/miua*( func.svp(t548(sst8(i):set8(i))+az).*rh548(sst8(i):set8(i))- func.svp(60+az)*0.01 )/dz;
%    figure;
%    i=2;
%    plot(dt8d(sst8(i):set8(i))-dt8d(zp8at(i)),va1(sst8(i):set8(i)))
...
%   adv2(sst8(i):set8(i))=-va(sst8(i):set8(i)).*func.rhovs(t538(sst8(i):set8(i))+az).*rh538(sst8(i):set8(i))  /rholw*ms2mmd;
    adv1(sst8(i):set8(i))=-va1(sst8(i):set8(i)).*func.rhovs(t548(sst8(i):set8(i))+az).*rh548(sst8(i):set8(i))  /rholw*ms2mmd;
  advm(sst8(i):set8(i))=-va(sst8(i):set8(i)).*func.rhovs( (t548(sst8(i):set8(i))+t538(sst8(i):set8(i))+2*az)/2 ).*(rh548(sst8(i):set8(i)) +rh538(sst8(i):set8(i)) )/2/rholw*ms2mmd;
...
figure
    semilogy(mc8f(sst8(3):iv:set8(3)),rsb(sst8(3):iv:set8(3),4),'ro');hold on    %F10 129.6
    semilogy(mc8f(sst8(2):iv:set8(2)),rsb(sst8(2):iv:set8(2),4),'b.');   


%    h=figure;
%    set(gcf,'Units','normalized', 'WindowStyle','docked','OuterPosition',[0 0 1 1],'toolbar','figure'); %maximized the window
...
% %   line([atb(3) atb(3)],yl,'LineStyle',':','Color','-','LineWidth',lw);
...
% %   line([atb(10) atb(10)],yl,'LineStyle','-.','Color','-','LineWidth',lw);
%     
...
% % %   line([arhb(3) arhb(3)],yl,'LineStyle',':','Color','-','LineWidth',lw);
...
% % %   line([arhb(10) arhb(10)],yl,'LineStyle','-.','Color','-','LineWidth',lw); 
% %   
% %  ax1=gca;set(ax1,'FontSize',tfs)  
...
% %  ylabel('Depth (m)','FontSize',fs,'FontWeight','bold')
%  saveas(h,['Analysis_Transient_60_Temperature','fig'],'fig')
%   fprintf(1, strcat('First Graph finished \n'));
%  h=figure;
%  set(gcf,'Units','normalized', 'WindowStyle','docked','OuterPosition',[0 0 1 1],'toolbar','figure'); %maximized the window
% %% plot Moisture content after translation
% subplot('Position',[0.55 0.70 0.43 0.28])
% i=2;h2=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% i=3;h3=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=6;h6=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=7;h7=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),mc8f(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% axis([0,8,0,1])
...
%  if (wl(i)==0 && so(i)==1)
% 
% plot(dt8d(sst8(i):set8(i))-dt8d(sst8(i)),aetsp8(sst8(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
%  end
% end
% 
% % i=2;h2=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=3;h3=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=4;h4=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=5;h5=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
...
% plot(dt8d(sst8(i):iv:set8(i))-dt8d(sst8(i)),adv1(sst8(i):iv:set8(i))/por,'+','LineWidth',lw,'color',col(i,:));hold on
% 
%  end
% end
% 
% 
% %i=2;h2=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% %i=3;h2=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% 
% 
% 
% xlabel('Time (day)','FontSize',fs)
...
% 
% 
% %  i=2;h2=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on 
% % i=3;h2=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('AET (mm)','FontSize',fs)
% ylabel('ET rate (mm/day)','FontSize',fs)
% %% Plot Transient evaporation rate as a function of saturation
% subplot('Position',[0.04 0.36 0.43 0.28])
%  i=2;h2=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
%  i=3;h2=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=4;h4=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=5;h5=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% 
...
% 
% 
%  i=2;h2=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
%  i=3;h2=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))*ms2mmd,'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('Time (day)','FontSize',fs)
...
% 
% 
% saveas(h,['Fine_Analysis_Transient_60_ETrate','.fig'],'fig')
...
% end
% 
% %  i=2;h3=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %  i=3;h3=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(aet6c(zpsat(i):sets(i))-aet6c(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('AET (mm)','FontSize',fs)
...
% 
% subplot('Position',[0.04 0.36 0.43 0.28])
%  i=2;h3=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
%   i=3;h3=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=3;h3=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(mc8f(zp8at(i):set8(i)),etsp8(zp8at(i):set8(i))/etsp8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('Saturation (-)','FontSize',fs)
% ylabel('ET rate (-)','FontSize',fs)
% axis([0,1,0,1.2])
...
% subplot('Position',[0.04 0.04 0.43 0.28])
%  i=2;h3=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% i=3;h4=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% % i=3;h3=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h6=plot(dt8d(zp8at(i):set8(i))-dt8d(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('Time (day)','FontSize',fs)
...
%  i=2;h3=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
%  i=3;h3=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h6=plot(aet6c8(zp8at(i):set8(i))-aet6c8(zp8at(i)),et6rh8(zp8at(i):set8(i))/et6rh8(zp8at(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% xlabel('Time (day)','FontSize',fs)
% ylabel('ET by RH (-)','FontSize',fs)
% 
...
% end
% 
% % i=2;h3=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=3;h3=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=4;h4=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %i=5;h5=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=6;h6=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % i=7;h7=plot(dtsd(zpsat(i):sets(i))-dtsd(zpsat(i)),etsgf6(zpsat(i):sets(i))/etsgf6(zpsat(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% 
% 
% 
% 
...
% 
% 
% saveas(h,['Fine_Analysis_Transient_60_nondimensional','.fig'],'fig')
...
% %   
% %   
% %    i=3;h3=plot(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=4;h4=plot(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=5;h5=plot(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=6;h6=plot(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=7;h7=plot(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   
% %   
% % 
% %   
...
% %   
% %   
% % %   i=3;h3=semilogy(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=4;h4=semilogy(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=5;h5=semilogy(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=6;h6=semilogy(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=7;h7=semilogy(mc8f(zp8at(i):set8(i)),rs(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   
% %   axis([0,1,1,1000])
% %   hleg1 = legend([ha,hb,hc,hd],{sprintf('Van der Griend et al. [1994]'),sprintf('Camillo et al. [1986]'),sprintf('Daamen et al. [1996]'), ...
% %   sprintf('Sun [1984]')},'Location','NorthEast');
...
% %   hc=plot(0.01:0.05:1,func.rs1996(0.01:0.05:1,por),':','LineWidth',lw,'color',col(i,:));hold on % Daamen 1996
% %   hd=plot(0.01:0.05:1,func.rs1984(0.01:0.05:1),'--','LineWidth',lw,'color',col(i,:));hold on % Sun 1984
% % %   i=3;h3=plot(mc8f(zp8at(i):set8(i)),rs2(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=4;h4=plot(mc8f(zp8at(i):set8(i)),rs2(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   i=5;h5=plot(mc8f(zp8at(i):set8(i)),rs2(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=6;h6=plot(mc8f(zp8at(i):set8(i)),rs2(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% % %   i=7;h7=plot(mc8f(zp8at(i):set8(i)),rs2(zp8at(i):set8(i)),'-','LineWidth',lw,'color',col(i,:));hold on
% %   
% %   
% % %   i=3;g3=plot(mc8f(zp8at(i):set8(i)),rst20(zp8at(i):set8(i)),'g-.','LineWidth',lw,'color',col(i,:));hold on
% %   i=4;g4=plot(mc8f(zp8at(i):set8(i)),rst20(zp8at(i):set8(i)),'c-.','LineWidth',lw,'color',col(i,:));hold on
% %   i=5;g5=plot(mc8f(zp8at(i):set8(i)),rst20(zp8at(i):set8(i)),'m-.','LineWidth',lw,'color',col(i,:));hold on
% % %   i=6;g6=plot(mc8f(zp8at(i):set8(i)),rst20(zp8at(i):set8(i)),'y-.','LineWidth',lw,'color',col(i,:));hold on
% % %   i=7;g7=plot(mc8f(zp8at(i):set8(i)),rst20(zp8at(i):set8(i)),'k-.','LineWidth',lw,'color',col(i,:));hold on
% %   
% %   
% % %   i=3;g32=plot(mc8f(zp8at(i):set8(i)),rst51(zp8at(i):set8(i)),'g--','LineWidth',lw,'color',col(i,:));hold on
% % %   i=4;g42=plot(mc8f(zp8at(i):set8(i)),rst51(zp8at(i):set8(i)),'c--','LineWidth',lw,'color',col(i,:));hold on
% % %   i=5;g52=plot(mc8f(zp8at(i):set8(i)),rst51(zp8at(i):set8(i)),'m--','LineWidth',lw,'color',col(i,:));hold on
% % %   i=6;g62=plot(mc8f(zp8at(i):set8(i)),rst51(zp8at(i):set8(i)),'y--','LineWidth',lw,'color',col(i,:));hold on
% % %   i=7;g72=plot(mc8f(zp8at(i):set8(i)),rst51(zp8at(i):set8(i)),'k--','LineWidth',lw,'color',col(i,:));hold on
% %   
% %   
% %   
% %   axis([0,1,-100,600])
...
% %   ylabel('rs (s/m)','FontSize',fs)
% %  %% save file
% %  saveas(h,['Fine_Analysis_Transient_60_Resistance','.fig'],'fig')
